...
class __TwigTemplate_783c42933e383f0b8507e0e59d25c1937d5cb46147453c3b6f0a25423e915729 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["hub"] => $context["publisher"]) {
                ...
                // line 62
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["publisher"], "messages", [], "any", false, false, false, 62));
                foreach ($context['_seq'] as $context["i"] => $context["message"]) {
                    ...
                    echo "</td>
                                    <td class=\"nowrap\">";
                    // line 65
                    echo twig_escape_filter($this->env, sprintf("%.0f", twig_get_attribute($this->env, $this->source, $context["message"], "duration", [], "any", false, false, false, 65)), "html", null, true);
                    echo " ms</td>
                                    <td class=\"nowrap\">";
                    // line 66
                    echo twig_escape_filter($this->env, sprintf("%.2f", ((twig_get_attribute($this->env, $this->source, $context["message"], "memory", [], "any", false, false, false, 66) / 1024) / 1024)), "html", null, true);
                    echo " MB</td>
                                    <td class=\"font-normal text-small text-bold nowrap\">";
                    // line 67
                    echo twig_escape_filter($this->env, twig_join_filter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["message"], "object", [], "any", false, false, false, 67), "topics", [], "any", false, false, false, 67), ","), "html", null, true);
                    echo "</td>
                                    <td>";
                    // line 68
                    echo $this->extensions['Symfony\Bridge\Twig\Extension\DumpExtension']->dump($this->env, $context, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["message"], "object", [], "any", false, false, false, 68), "data", [], "any", false, false, false, 68));
                    echo "</td>
                                    <td class=\"nowrap\">";
                    // line 69
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["message"], "object", [], "any", false, false, false, 69), "id", [], "any", false, false, false, 69), "html", null, true);
                    echo "</td>
                                    <td class=\"nowrap\">";
                    // line 70
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["message"], "object", [], "any", false, false, false, 70), "type", [], "any", false, false, false, 70), "html", null, true);
                    echo "</td>
                                    <td class=\"nowrap\">";
                    // line 71
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["message"], "object", [], "any", false, false, false, 71), "retry", [], "any", false, false, false, 71), "html", null, true);
                    echo "</td>
                                </tr>
                            ";
                }
    ...
    {
        return array (  260 => 78,  251 => 74,  242 => 71,  238 => 70,  234 => 69,  230 => 68,  226 => 67,  222 => 66,  218 => 65,  214 => 64,  211 => 63,  207 => 62,  186 => 44,  179 => 40,  170 => 36,  167 => 35,  163 => 34,  160 => 33,  154 => 29,  152 => 28,  147 => 25,  144 => 24,  134 => 23,  120 => 18,  115 => 17,  105 => 16,  92 => 12,  89 => 11,  84 => 9,  79 => 8,  76 => 7,  73 => 6,  63 => 5,  52 => 1,  50 => 3,  37 => 1,);
    }
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Mercure/Collector/mercure.html.twig", "/srv/app/vendor/symfony/mercure-bundle/src/Resources/views/Collector/mercure.html.twig");
    }
}
